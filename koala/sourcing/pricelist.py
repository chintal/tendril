...
from koala.conventions import iec60063
from koala.utils.types import currency
from koala.utils.config import PRICELISTVENDORS_FOLDER
...
class VendorPricelist(vendors.VendorBase):
    ...
    def _get_generator_idents(self, pricegen):
        return [koala.conventions.electronics.ident_transform(pricegen['device'],
                                                              x,
                                                              pricegen['footprint'])
