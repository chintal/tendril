...
from koala.gedaif import gsymlib
...
class CompositeOrderElem(object):
    def __init__(self, order, ident, rqty, shortage):
        ...
        try:
            self._sources = koala.sourcing.electronics.get_sourcing_information(self.ident, self.gl_compl_qty,
        ...
        except koala.sourcing.electronics.SourcingException:
            self._sources = None
    ...
    def gl_compl_qty(self):
        return koala.inventory.guidelines.electronics_qty.get_compliant_qty(self.ident, self.shortage)
