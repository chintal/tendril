...
"""
The Filesystem Utils Module (:mod:`koala.utils.fs`)
===================================================
...
#:
#: This directory will be removed by Koala at clean application exit or
#: by the Operating System as per it's policies.
#:
#: Every execution of koala in a separate process owns it's own temporary
#: directory.
#:
...
#: code. While it resides in the :mod:`koala.utils.fs` module, the same
...
def fsutils_cleanup():
    ...
    `koala.utils.fs` related objects and other artifacts created by the
    module.
