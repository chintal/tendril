...
"""
Base Unit Types (:mod:`koala.utils.types.unitbase`)
===================================================
...
class UnitBase(object):
    """
    The base class for all :mod:`koala.utils.types` units.
...
class NumericalUnitBase(UnitBase):
    """
    The base class for all :mod:`koala.utils.types` numerical units.
