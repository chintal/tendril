...
from koala.frontend.users.models import User, UserAuth, Role
...
def reset_db(app, db):
    ...
    from koala.utils.config import ADMIN_USERNAME
    from koala.utils.config import ADMIN_FULLNAME
    from koala.utils.config import ADMIN_EMAIL
    from koala.utils.config import ADMIN_PASSWORD
