...
import koala.utils.log
logger = koala.utils.log.get_logger(__name__, koala.utils.log.INFO)

import os
import subprocess
import pyparsing

import koala.utils.pdf

from koala.utils.types.lengths import Length
from koala.utils.types.cartesian import CartesianPoint
from koala.utils.types.cartesian import CartesianLineSegment
...
def conv_pcb2pdf(pcbpath, docfolder, projname):
    ...
    koala.utils.pdf.conv_ps2pdf(psfile, pdffile)
    os.remove(psfile)
    return pdffile
