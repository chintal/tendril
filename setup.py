...
install_requirements = [
    ...
    'tendril-utils-www>=0.1.3',
    'tendril-utils-types>=0.1.3',
    ...
    'tendril-dox-render>=0.1.5',
    'tendril-dox-labelmaker>=0.1.5',
    'tendril-dox-wallet>=0.1.2',
    'tendril-entities-base>=0.1.2',
    'tendril-prototype-base>=0.1.1',
    'tendril-products>=0.1.4',
