...
\lohead{\tt \ptitle  AM  \pcbname\ S.\sno}    %% Top left on even pages
...
\rehead{\tt \ptitle  AM  \pcbname\ S.\sno}    %% Top right on odd pages
\chead{}                       %% Top center
...
\small{S.No.:} & {\ttfamily\bfseries\normalsize \sno} & Stock Indent: & %{{stage.stockindent%}}\\
