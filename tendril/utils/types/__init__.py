...
standard or third-party package. In the case of :mod:`tendril.utils.types`, this
...
existence in Tendril is largely due to a combination of the *Not Invented Here*
syndrome, as well as the overwhelming number of possible options available,
none of which seem to be ideal drop in replacements for Tendril core's
requirements.

While you can use the units and data structures from :mod:`tendril.utils.types`
independent of the rest of Tendril, you probably should not. The code itself
should function, but it lacks the thoroughness of type-checking or the
efficiency of more full fledged implementations. Even when using Tendril units
to handle data generated by one of the Tendril submodules, I strongly recommend
...
- The fundamental nature of unit instantiation must remain stable and consistent
  ...
  Tendril expects. More importantly, changing the underlying implementation
...
.. warning::
  ...
  pulled out of Tendril into it's own units library, and maintaining that isn't
