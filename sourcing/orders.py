...
class CompositeOrderElem(object):
    def __init__(self, order, ident, rqty, shortage):
        ...
        try:
            self._sources = sourcing.electronics.get_sourcing_information(self.ident, self.gl_compl_qty,
    ...
    @property
    def in_gsymlib(self):
        if gedaif.gsymlib.is_recognized(self.ident):
            return "YES"
        return None
    ...
    def gl_compl_qty(self):
        return inventory.guidelines.electronics_qty.get_compliant_qty(self.ident, self.shortage)
